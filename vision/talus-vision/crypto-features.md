...
The session data is stored locally in your browser and used to encrypt and decrypt your data when executing encrypted workflows. All keys are stored exclusively in your browser, and all blockchain operations are signed with your Sui wallet.
