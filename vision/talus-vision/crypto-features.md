...
2. An encrypted session is initiated using the X3DH protocol and recorded on the blockchain. X3DH is a handshake algorithm used to establish a secure session between two parties.
