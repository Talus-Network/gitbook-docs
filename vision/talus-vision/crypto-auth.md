...
**Crypto Auth** is a **secure authentication system** required to execute **encrypted workflows**. On first use, a unique **master key** is generated in your browser and stored in encrypted form.
...
After logging in with your wallet, if the **Crypto Auth** process has not been completed previously, you will need to perform it. A dedicated button for this action is available in the **application header**.
...
<figure><img src="../.gitbook/assets/Screenshot 2025-11-11 at 12.20.26.png" alt=""><figcaption></figcaption></figure>
