...
This demo provides users with the following capabilities:
...
- Access to previously deployed workflows, which can be reused as templates or executed directly  
...
- Support for multiple Sui networks (Mainnet and Testnet) through an in-app network switcher  
- A built-in on-chain Explorer for browsing deployed workflows, execution history, and scheduled tasks  
- Scheduled execution through Queue and Periodic tasks, in addition to immediate on-chain runs  
- The ability to register and manage your own Nexus tools—both off-chain and on-chain—directly from the interface  
- Community tools loaded from the on-chain tool registry, shown alongside official Talus-built tools
